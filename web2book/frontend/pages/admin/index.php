...
// Calculate revenue (mock data for demo - in real app, calculate from rental controller)
$totalRevenue = $rentalStats['active_rentals'] * 50000; // Estimated
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const revenueData = [1200000, 1900000, 1600000, 2200000, 2800000, 2500000, 3100000, 3500000];
